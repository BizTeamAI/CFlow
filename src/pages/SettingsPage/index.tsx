...
export default function SettingsPage(): JSX.Element {
  ...
  if (!ENABLE_DATASTAX_CFLOW) {
    const cflowItems = CustomStoreSidebar(true, ENABLE_CFLOW_STORE);
    sidebarNavItems.splice(2, 0, ...cflowItems);
  }
  ...
  return (
    <PageLayout
      backTo={-1 as To}
      title="Settings"
      description="Manage the general settings for CFlow."
    >
