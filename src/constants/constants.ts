...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the CFlow documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "CFlow: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret CFlow API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const CFLOW_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const CFLOW_CHAT_TITLE = "CFlow Chat";
...
export const STORE_TITLE = "CFlow Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your CFlow API key.";
...
export const CFLOW_ACCESS_TOKEN = "access_token_lf";
export const CFLOW_API_TOKEN = "apikey_tkn_lflw";
export const CFLOW_AUTO_LOGIN_OPTION = "auto_login_lf";
export const CFLOW_REFRESH_TOKEN = "refresh_token_lf";

export const CFLOW_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const CFLOW_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
...
export const IS_AUTO_LOGIN =
  !process?.env?.CFLOW_AUTO_LOGIN ||
  String(process?.env?.CFLOW_AUTO_LOGIN)?.toLowerCase() !== "false";
