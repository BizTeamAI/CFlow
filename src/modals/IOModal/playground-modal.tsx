//import CFlowLogoColor from "@/assets/CFlowLogocolor.svg?react";
...
import { CFlowButtonRedirectTarget } from "@/customization/utils/urls";
...
export default function IOModal({
  ...
  const CFlowButtonClick = () => {
    track("CFlowButtonClick");
    customOpenNewTab(CFlowButtonRedirectTarget());
  };
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    <Button
                      onClick={CFlowButtonClick}
                      variant="primary"
                      className="w-full !rounded-xl shadow-lg"
                    >
                      <CFlowLogoColor />
                      <div className="text-sm">Built with CFlow</div>
                    </Button>
                  </div>
                )}
              </div>
              ...
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                ...
                >
                  <Button
                    ...
                    onClick={CFlowButtonClick}
                  >
                    <CFlowLogoColor className="h-[18px] w-[18px] scale-150" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
