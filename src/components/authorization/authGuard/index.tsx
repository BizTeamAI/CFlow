...
import {
  IS_AUTO_LOGIN,
  CFLOW_ACCESS_TOKEN_EXPIRE_SECONDS,
  CFLOW_ACCESS_TOKEN_EXPIRE_SECONDS_ENV,
...
export const ProtectedRoute = ({ children }) => {
  ...
  useEffect(() => {
    const envRefreshTime = CFLOW_ACCESS_TOKEN_EXPIRE_SECONDS_ENV;
    const automaticRefreshTime = CFLOW_ACCESS_TOKEN_EXPIRE_SECONDS;
